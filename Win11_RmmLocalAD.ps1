...
Write-Host -ForegroundColor Cyan "             RMM Deployment Task Sequence (Win11 Pro en-US Retail)"
Write-Host -ForegroundColor Cyan "========================================================================================="
Write-Host -ForegroundColor Cyan ""
...
# Ask user for the computer name and RmmId
Write-Host -ForegroundColor Yellow "  Need to know the Computer name and  RMM Customer ID."
$computerName = Read-Host "  Enter the computer name (CUST-SITE-RMM)"
            ...
            <UserAccounts>
                <LocalAccounts>
                    <LocalAccount wcm:action="add">
                        <Description>Local Admin Account for Van Tornhout IT</Description>
                        <DisplayName>vtAdmin Local | Van Tornhout IT</DisplayName>
                        <Group>Administrators</Group>
                        <Name>vtAdminLocal</Name>
                    </LocalAccount>
                </LocalAccounts>
            </UserAccounts>
            <RegisteredOrganization>Van Tornhout</RegisteredOrganization>
            <RegisteredOwner>vtAdminLocal</RegisteredOwner>
...
<#
.SYNOPSIS
Configures a PC for use as a general RMM PC when no local servers or local AD are available. Can also be used to install printer supplies monitors like EKM and Xerox MPS
